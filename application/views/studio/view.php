...
<body>
  ...
  <header id="header" class="d-flex flex-column justify-content-center">
    ...
    <nav id="navbar" class="navbar nav-menu">
      <ul>
        <li><a href="<?= base_url('/'); ?>admin" class="nav-link scrollto"><i class="bx bx-home"></i><span>Home</span></a></li>
        
        <li><a href="<?= base_url('/'); ?>studio/add_studio" class="nav-link scrollto"><i class="bx bx-home"></i><span>Add studio</span></a></li>
        <li><a href="<?= base_url('/'); ?>studio/edit" class="nav-link scrollto"><i class="bx bx-home"></i><span>edit studio</span></a></li>
        
        <!--<li><a href="#notification" class="nav-link scrollto"><i class="bx bx-notification"></i><span>Notification</span></a></li>
            ...
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
                ...
                <div class="portfolio-links">
                  ...
                  <a href="<?= base_url('studio');?>" class="portfolio-details-lightbox" data-glightbox="type: external" title="Portfolio Details"><i class="bx bx-link"></i></a>
                </div>
              </div>
            </div>
          </div>
