...
<body>
  ...
  <section id="hero" class="d-flex flex-column justify-content-center">
    <div class="container" data-aos="zoom-in" data-aos-delay="100">
      <h1>Welcome ! </h1>
      <p>Home <span class="typed" data-typed-items="Final - Records"></span></p>
    </div>
  </section><!-- End Hero -->
  ...
  <main id="main">
    ...
    <section id="portfolio" class="portfolio section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <?php foreach ($studio as $studios) : ?>
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            <div class="portfolio-wrap">
              <img src="<?php echo base_url();?>/assets/studio/<?php echo $studios->gambar ?>" class="img-fluid" alt="">
              <div class="portfolio-info">
                <h4><?= $studios->nama_studio; ?></h4>
                <p><?= $studios->tarif; ?></p>
                <div class="portfolio-links">
                  <a href="<?php echo base_url();?>/assets/studio/<?php echo $studios->gambar ?>" data-gallery="portfolioGallery" class="portfolio-lightbox" title="<?= $studios->deskripsi; ?>"><i class="bx bx-plus"></i></a>
                  <a href="<?= base_url('admin/studio/admin_edit_studio');?>" class="portfolio-details-lightbox" data-glightbox="type: external" title="Portfolio Details"><i class="bx bx-link"></i></a>
                </div>
              </div>
            </div>
          </div>
